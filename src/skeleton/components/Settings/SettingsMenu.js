...
export default function SettingsMenu() {
  ...
  return (
    <div style={{
      width: "100%", height: '94vh', backgroundImage: 'linear-gradient(to right, rgb(39, 39, 39),rgb(0, 0, 0))',
      // backgroundColor: '#d5e5e5',
      color: 'var(--body_color)',
      overflowY: 'auto',
      backdropfilter: 'blur(8.6px)',
      WebkitBackdropFilter: 'blur(8.6px)', // Adjust the blur level as needed>
    }}>
      <Box>
        <Tabs value={selectedTab} indicatorColor="primary" textColor='var(--body_color)' centered onChange={handleTabChange}>
          <Tab label="Connection Details" {...a11yProps(0)} style={{ color: 'white', fontSize: '1.4vh' }} />
          {/* <Tab label="Calibration Details" {...a11yProps(1)} style={{ color: 'var(--body_color)', fontSize: '1.4vh' }} /> */}
          <Tab label="Ard Comms Module" {...a11yProps(1)} style={{ color: 'white', fontSize: '1.4vh' }} />
