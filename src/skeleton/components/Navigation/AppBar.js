...
import {
  sendAction,
  check_if_updated_downloaded,
  installUpdate,
  checkIfUpdateAvailable,
  checkIfUpdateDownloaded,
  quitandInstallFromLocal,
...
function ResponsiveAppBar() {
  ...
  const isDemoMode = useSelector(
    (state) => state.connection_settings.DEMO_MODE,
  );
  ...
  return (
    <div>
            ...
            >
              ...
              >
                <MenuItem sx={{ minWidth: "220px", padding: "12px 16px" }}>
                  <PermIdentityIcon
                    sx={{ color: "#3b82f6", marginRight: "12px", fontSize: 20 }}
                  />
                  <Typography
                    variant="body2"
                    sx={{
                ...
                <MenuItem onClick={openAdmin} disabled={user.access_level < 2}>
                  <PermIdentityIcon
                    sx={{ marginRight: "12px", fontSize: 20, color: "#6b7280" }}
                  />
                  <Typography
                    variant="body2"
                    sx={{
                ...
                >
                  <Box display="flex" alignItems="center">
                    ...
                    {updateDownloaded && (
                      <HelpOutlineIcon
                        sx={{ marginLeft: 1, fontSize: 16, color: "#10b981" }}
                      />
                    )}
                  </Box>
                </MenuItem>
      ...
      {updateDownloaded && (
        <Dialog
          open={updateCheckDialog}
          onClose={() => setUpdateCheckDialog(false)}
        >
          <DialogTitle
            sx={{
              fontFamily: '"Inter", "Roboto", sans-serif',
          ...
          <DialogContent>
            <Typography sx={{ fontFamily: '"Inter", "Roboto", sans-serif' }}>
              A system update is available. Would you like to quit and install
              now?
            </Typography>
          </DialogContent>
          <DialogActions>
