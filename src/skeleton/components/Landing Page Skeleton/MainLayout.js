...
export function Dashboard() {
  ...
  const activePlugin = plugins.find(
    (plugin) => plugin.instanceId === activeComponent,
  );
  ...
  return (
    <div>
      <Box sx={{ display: "flex", height: "94vh", backgroundColor: "#1a1a1a" }}>
        {/* Professional Sidebar */}
        <Box
          sx={{
            width: isSidebarOpen ? "320px" : "80px",
            background:
              "linear-gradient(180deg, #0f0f0f 0%, #1a1a1a 50%, #2d2d2d 100%)",
            color: "#fff",
                      ...
                      <Tooltip title={plugin.instanceId} placement="right">
                        <Box
                          sx={{
                            ...
                            borderRadius: "8px",
                            background:
                              activeComponent === plugin.instanceId
              ...
              <Box sx={{ padding: "24px 0", flex: 1 }}>
                ...
                <Box
                  sx={{
                    ...
                    fontWeight: 600,
                    color:
                      activeComponent === "dashboard" ? "#ffffff" : "#cbd5e1",
                    background:
                      activeComponent === "dashboard"
        ...
        >
          ...
          {plugins.map((plugin, index) => (
            <div
              ...
              id={`plugin-container-${index}`}
              style={{
                display:
                  activeComponent === plugin.instanceId ? "block" : "none",
              }}
            >
              Loading
            </div>
        ...
        {activePlugin &&
          (activePlugin.name || activePlugin.instanceId) !== "Dashboard" && (
            <Chip
